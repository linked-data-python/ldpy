...
| **Look something up** | Reference: [the language](reference/language.md) · [command line](reference/cli.md) · [Python API](reference/api.md) · [language map](reference/language-map.md) |
...
Design decisions are recorded in the research project's `DESIGN_CHOICES/`
records; the ESWC article draft gives the academic account.
